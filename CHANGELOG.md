...
- Update transformers version constraint to >=5.3.0,<6.0.0 and sentence_transformers to >=5.0.0,<6.0.0 ([#615](https://github.com/opensearch-project/opensearch-py-ml/pull/615))
...
- Update model upload history -  sentence-transformers/distiluse-base-multilingual-cased-v1 (v.1.0.2)(TORCH_SCRIPT) by @nathaliellenaa ([#582](https://github.com/opensearch-project/opensearch-py-ml/pull/582))
