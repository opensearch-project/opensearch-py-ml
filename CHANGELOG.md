...
- Update model upload history -  sentence-transformers/msmarco-distilbert-base-tas-b (v.1.0.2)(BOTH) by @dhrubo-os ([#296](https://github.com/opensearch-project/opensearch-py-ml/pull/296))
