...
- Update model upload history -  sentence-transformers/paraphrase-MiniLM-L3-v2 (v.1.0.2)(BOTH) by @nathaliellenaa ([#576](https://github.com/opensearch-project/opensearch-py-ml/pull/576))
