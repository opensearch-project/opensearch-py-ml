...
- Update model upload history -  sentence-transformers/distiluse-base-multilingual-cased-v1 (v.1.0.1)(TORCH_SCRIPT) by @dhrubo-os ([#298](https://github.com/opensearch-project/opensearch-py-ml/pull/298))
