...
class TestOpenAIModel(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.openai_model.opensearch_domain_name, self.opensearch_domain_name)
        self.assertEqual(self.openai_model.opensearch_username, self.opensearch_username)
        self.assertEqual(self.openai_model.opensearch_password, self.opensearch_password)
    ...
    def test_register_openai_model(self, mock_input):
        ...
        self.openai_model.register_openai_model(mock_helper, mock_config, mock_save_config)
    ...
    def test_register_openai_model_opensource(self, mock_time, mock_input):
        ...
        self.openai_model.register_openai_model_opensource(mock_opensearch_client, mock_config, mock_save_config)
    ...
    def test_wait_for_model_registration_success(self, mock_sleep, mock_time):
        ...
        result = self.openai_model.wait_for_model_registration(mock_opensearch_client, 'test-task-id')
    ...
    def test_wait_for_model_registration_timeout(self, mock_sleep, mock_time):
        ...
        result = self.openai_model.wait_for_model_registration(mock_opensearch_client, 'test-task-id', timeout=5)
        self.assertIsNone(result)
