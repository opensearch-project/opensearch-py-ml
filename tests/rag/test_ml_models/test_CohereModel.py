...
class TestCohereModel(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            self.cohere_model.opensearch_domain_name, self.opensearch_domain_name
        )
        self.assertEqual(
            self.cohere_model.opensearch_username, self.opensearch_username
        )
        self.assertEqual(
            self.cohere_model.opensearch_password, self.opensearch_password
        )
    ...
    def test_wait_for_model_registration_success(self, mock_sleep, mock_time):
        ...
        result = self.cohere_model.wait_for_model_registration(
