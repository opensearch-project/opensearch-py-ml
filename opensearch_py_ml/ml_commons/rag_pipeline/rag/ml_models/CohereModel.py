...
class CohereModel:
    ...
    def register_cohere_model(self, helper, config, save_config_method):
        ...
        print(f"{Fore.GREEN}Cohere model registered successfully. Model ID '{model_id}' saved in configuration.{Style.RESET_ALL}")

    def register_cohere_model_opensource(self, opensearch_client, config, save_config_method):
        """
